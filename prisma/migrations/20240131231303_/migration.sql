/*
  ...
  - You are about to drop the column `assements` on the `Barbershop` table. All the data in the column will be lost.
...
-- AlterTable
ALTER TABLE "Barbershop" DROP COLUMN "assements",
